...
public class BeaconLocalBroadcastProcessor {
    ...
    public static final String RANGE_NOTIFICATION = "com.ktpci.beacon.range_notification";
    public static final String MONITOR_NOTIFICATION = "com.ktpci.beacon.monitor_notification";
