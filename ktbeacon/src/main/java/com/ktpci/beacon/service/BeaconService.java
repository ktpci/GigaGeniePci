...
import com.ktpci.beacon.BeaconLocalBroadcastProcessor;
import com.ktpci.beacon.BeaconManager;
import com.ktpci.beacon.BeaconParser;
import com.ktpci.beacon.BuildConfig;
import com.ktpci.beacon.Region;
import com.ktpci.beacon.distance.DistanceCalculator;
import com.ktpci.beacon.distance.ModelSpecificDistanceCalculator;
import com.ktpci.beacon.logging.LogManager;
import com.ktpci.beacon.service.scanner.CycledLeScanCallback;
import com.ktpci.beacon.startup.StartupBroadcastReceiver;
import com.ktpci.beacon.utils.ProcessUtils;
...
public class BeaconService extends Service {
                ...
                if (startRMData != null) {
                    switch (msg.what) {
                        case MSG_START_RANGING:
                            ...
                            service.startRangingBeaconsInRegion(startRMData.getRegionData(), new com.ktpci.beacon.service.Callback(startRMData.getCallbackPackageName()));
                        ...
                        case MSG_START_MONITORING:
                            ...
                            service.startMonitoringBeaconsInRegion(startRMData.getRegionData(), new com.ktpci.beacon.service.Callback(startRMData.getCallbackPackageName()));
                            service.setScanPeriods(startRMData.getScanPeriod(), startRMData.getBetweenScanPeriod(), startRMData.getBackgroundFlag());
                            break;
    ...
    public void onCreate() {
        ...
        try {
            Class klass = Class.forName("com.ktpci.beacon.SimulatedScanData");
            java.lang.reflect.Field f = klass.getField("beacons");
            mScanHelper.setSimulatedScanData((List<Beacon>) f.get(null));
        } catch (ClassNotFoundException e) {
            LogManager.d(TAG, "No com.ktpci.beacon.SimulatedScanData class exists.");
        } catch (Exception e) {
            LogManager.e(e, TAG, "Cannot get simulated Scan data.  Make sure your com.ktpci.beacon.SimulatedScanData class defines a field with the signature 'public static List<Beacon> beacons'");
        }
